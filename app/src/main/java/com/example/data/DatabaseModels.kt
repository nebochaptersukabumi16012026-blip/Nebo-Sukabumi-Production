...
data class Anggota(
    ...
    val username: String = "",
    val password: String = "",
    @Json(name = "tgl_gabung") @ColumnInfo(name = "tanggal_bergabung") val tanggalBergabung: Long = System.currentTimeMillis(),
    ...
    @ColumnInfo(name = "total_tagihan") val totalTagihan: Double = 0.0,
    ...
    @ColumnInfo(name = "lama_cicilan") val lamaCicilan: Int = 0,
