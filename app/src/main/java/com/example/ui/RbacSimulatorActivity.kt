...
class RbacSimulatorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_rbac_simulation)

        // =========================================================================
        // 2. Support ActionBar Back Button
        // Mengaktifkan tombol panah back di bagian atas Toolbar
        // =========================================================================
        ...
        fun updateUI() {
            ...
            // Hak Akses Fitur Berdasarkan RBAC
        ...
        // =========================================================================
        // 3. Listener Tombol Kembali ke Dashboard
        // =========================================================================
    ...
    // =========================================================================
    // 4. Handle Tombol Back pada ActionBar
    // =========================================================================
